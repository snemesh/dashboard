...
abstract class myDataStore implements ActiveRecordInterface
{
    ...
    /**
     * The value for the datamonth field.
     *
     * @var        DateTime
     */
    protected $datamonth;
    ...
    /**
     * The value for the datayear field.
     *
     * @var        DateTime
     */
    protected $datayear;
    ...
    /**
     * Get the [optionally formatted] temporal [datamonth] column value.
     *
     *
     * @param      string $format The date/time format string (either date()-style or strftime()-style).
     *                            If format is NULL, then the raw DateTime object will be returned.
     ...
     * @throws PropelException - if unable to parse/validate the date/time value.
     */
    public function getDataMonth($format = NULL)
    {
        if ($format === null) {
            return $this->datamonth;
        } else {
            return $this->datamonth instanceof \DateTimeInterface ? $this->datamonth->format($format) : null;
        }
    }

    /**
     * Get the [optionally formatted] temporal [datayear] column value.
     *
     *
     * @param      string $format The date/time format string (either date()-style or strftime()-style).
     *                            If format is NULL, then the raw DateTime object will be returned.
     ...
     * @throws PropelException - if unable to parse/validate the date/time value.
     */
    public function getDataYear($format = NULL)
    {
        if ($format === null) {
            return $this->datayear;
        } else {
            return $this->datayear instanceof \DateTimeInterface ? $this->datayear->format($format) : null;
        }
    }
    ...
    public function setData($v)
    {
        ...
        if ($this->data !== null || $dt !== null) {
            if ($this->data === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->data->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[myDataStoreTableMap::COL_DATA] = true;
            }
    ...
    /**
     * Sets the value of [datamonth] column to a normalized version of the date/time value specified.
     *
     * @param  mixed $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\myDataStore The current object (for fluent API support)
    ...
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->datamonth !== null || $dt !== null) {
            if ($this->datamonth === null || $dt === null || $dt->format("Y-m-d") !== $this->datamonth->format("Y-m-d")) {
                $this->datamonth = $dt === null ? null : clone $dt;
                $this->modifiedColumns[myDataStoreTableMap::COL_DATAMONTH] = true;
            }
        } // if either are not null
    ...
    /**
     * Sets the value of [datayear] column to a normalized version of the date/time value specified.
     *
     * @param  mixed $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\myDataStore The current object (for fluent API support)
    ...
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->datayear !== null || $dt !== null) {
            if ($this->datayear === null || $dt === null || $dt->format("Y-m-d") !== $this->datayear->format("Y-m-d")) {
                $this->datayear = $dt === null ? null : clone $dt;
                $this->modifiedColumns[myDataStoreTableMap::COL_DATAYEAR] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : myDataStoreTableMap::translateFieldName('Data', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->data = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : myDataStoreTableMap::translateFieldName('DataMonth', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->datamonth = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : myDataStoreTableMap::translateFieldName('DataYear', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->datayear = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;
            $this->resetModified();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(myDataStoreTableMap::COL_DATA)) {
            $modifiedColumns[':p' . $index++]  = 'data';
        }
        if ($this->isColumnModified(myDataStoreTableMap::COL_DATAMONTH)) {
            $modifiedColumns[':p' . $index++]  = 'datamonth';
        }
        if ($this->isColumnModified(myDataStoreTableMap::COL_DATAYEAR)) {
            $modifiedColumns[':p' . $index++]  = 'datayear';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'data':
                        ...
                        break;
                    case 'datamonth':
                        $stmt->bindValue($identifier, $this->datamonth ? $this->datamonth->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'datayear':
                        $stmt->bindValue($identifier, $this->datayear ? $this->datayear->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[6] => $this->getData(),
            $keys[7] => $this->getDataMonth(),
            $keys[8] => $this->getDataYear(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 6:
                ...
                break;
            case 7:
                $this->setDataMonth($value);
                break;
            case 8:
                $this->setDataYear($value);
                break;
        } // switch()
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[7], $arr)) {
            $this->setDataMonth($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setDataYear($arr[$keys[8]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(myDataStoreTableMap::COL_DATA)) {
            $criteria->add(myDataStoreTableMap::COL_DATA, $this->data);
        }
        if ($this->isColumnModified(myDataStoreTableMap::COL_DATAMONTH)) {
            $criteria->add(myDataStoreTableMap::COL_DATAMONTH, $this->datamonth);
        }
        if ($this->isColumnModified(myDataStoreTableMap::COL_DATAYEAR)) {
            $criteria->add(myDataStoreTableMap::COL_DATAYEAR, $this->datayear);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setDataMonth($this->getDataMonth());
        $copyObj->setDataYear($this->getDataYear());
        if ($makeNew) {
            $copyObj->setNew(true);
